              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" id="approve" name="status" value="approve" checked="checked">
                    <span>Approve</span>
...
                    <span>Reject</span><br>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="petty_remarks" class="form-control" name="petty_remarks" rows="3" style="resize: none;" autocomplete="off"><?=$result->petty_remarks?></textarea>
                  </div>
