...
<script type="text/javascript">
    ...
    function tambah_tr_petty(ids, urls) {

        // alert(ids+" "+urls);

        $(".trparent_petty").first().clone()
...
<?php echo form_open_multipart(base_url()."index.php/petty_cash/save_petty/"); ?>
                        ...
                        <div style="overflow:scroll;overflow-y:hidden;width:auto; ">
                            ...
                            <table class="table table-bordered cn">
                                ...
                                <tr class="trparent_petty">
                                          ...
                                          <td align="center" style="vertical-align: middle;"> <a id="img_add" onclick="tambah_tr_petty('<?php echo base_url(); ?>')" style="cursor:pointer"><span class="fa fa-plus" aria-hidden="true"></span></a></td>

                                </tr>

                                <tbody class="trchild_petty"></tbody>      
