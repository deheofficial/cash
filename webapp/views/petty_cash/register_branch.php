...
<?php echo form_open_multipart(base_url()."index.php/lzs/save_new_branch/"); ?>
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="branch_name" id="branch_name" value="<?=$result->branch_name?>" autocomplete="off">
                  </div>
