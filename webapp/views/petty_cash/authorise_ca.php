...
<?php echo form_open_multipart(base_url()."index.php/cash_advance/save_authorise_ca/".$ca_id); ?>
            ...
            <div class="card card-primary">
              ...
              <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="ca_project" value="<?= $result->category ?>">
                </div>
                  ...
                  <div class="form-group">
                    <label for="ca_status">Status</label><br>                    
                    <input type="radio" id="authorise" name="ca_status" value="authorise" >
                    <span>Authorise</span>
                    <input type="radio" id="reject" name="ca_status" value="reject">
                    <span>Reject</span><br>
                  </div>
                  
                  <div class="form-group">
                    <label for="ca_remarks">Remarks</label>
                    <textarea id="ca_remarks" class="form-control" name="ca_remarks" rows="3" style="resize: none;" autocomplete="off"><?=$result->ca_remarks?></textarea>
                  </div>
