            ...
            <div class="card card-primary">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="purpose" class="form-control" name="ca_purpose" rows="3" style="resize: none;"><?=$result->purpose?></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <?php $options = getData4ListBox("company", array(), array(), array('company_name', 'ASC'), 'company_id', 'company_name');
                          echo form_dropdown('ca_company',$options,$this->input->post('petty_company')?$this->input->post('petty_company'):$result->company, 'class="form-control" ');?>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ca_cash" id="ca_cash" value="<?=$result->ca_cash?>" autocomplete="off">
                  </div>
