...
class CI_DB_active_record extends CI_DB_driver {
    ...
    public function offsetcolumn($offset) {
        $this->ar_offsetcolumn = $offset;
        return $this;
    }
    ...
    protected function _compile_select($select_override = FALSE) {
        ...
        if (is_numeric($this->ar_limit)) {
            $sql .= "\n";
            $sql = $this->_limit($sql, $this->ar_limit, $this->ar_offset, $this->ar_offsetcolumn);
        }
