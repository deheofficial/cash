...
function tambah_tr(urls){
	...
	// alert($('input[name*="item_description"]').length);return false;
    ...
    .replaceWith('<input type="text" name="item_description[]" class="form-control" id="item_description'+counter+'" onkeyup="autoSuggestItemX(\'item_description'+counter+'\' , \''+urls+'getItemX/\'+this.value+\'/\' ,  \''+counter+'\')"  />')
    .end()
    .find("#vendor")
    ...
    .end()
    .find("#item_code")
    .replaceWith('<input type="text" name="item_code[]" class="form-control" id="item_code'+counter+'" onkeyup="autoSuggestItemCode(\'item_code'+counter+'\' , \''+urls+'getItemCode/0/\'+this.value+\'/\' ,  \''+counter+'\')"  />')
    .end()
    .find("#qty")
    ...
    .end()
    .find("#item_glcode")
    .replaceWith('<input type="text" name="item_glcode[]" class="form-control" id="item_glcode'+counter+'" onkeyup="autoSuggestItemCode(\'item_code'+counter+'\' , \''+urls+'getItemCode/0/\'+this.value+\'/\' ,  \''+counter+'\')" readonly="readonly" />')
    .end()
    .find("#img_add")
    .replaceWith("<a onclick='deleteRow(this);counter--;' style=\"cursor:pointer\"><span class='glyphicon glyphicon-minus' aria-hidden='true'></span></a>")
